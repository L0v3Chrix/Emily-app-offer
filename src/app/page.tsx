...
import AppChoiceCards from '@/components/AppChoiceCards';
...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    // TEMP: Always show onboarding for testing (remove sessionStorage check)
  ...
  const handleOpenTreasureMapFromOnboarding = () => {
  ...
  const possibilities = [
    ...
    },
    {
      ...
      description: "They see your calendar, pick a time, book instantly—all in 90 seconds",
    ...
    <div className="min-h-screen bg-gradient-to-br from-besty-mint via-white to-besty-gray-light text-besty-gray">
      ...
      {mounted && showOnboarding && (
        <OnboardingModal
          ...
          onOpenTreasureMap={handleOpenTreasureMapFromOnboarding}
        />
      )}
      ...
      {/* Choose Your Adventure - App Choice Cards */}
              ...
              <div className="relative">
                ...
                <div className="relative bg-gradient-to-br from-white to-besty-gray-light backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border border-besty-coral/30 shadow-2xl group">
                  ...
                  <div
                    ...
                    onClick={() => {
                      if (interactionScore >= 8 && !foundCodes.includes('HAUNTED20')) {
                        handleCodeClick('HAUNTED20');
                      }
                    }}
                    title={interactionScore >= 8 ? "👻 Look carefully..." : ""}
                  >
                    <img
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            {[
              ...
              },
              {
                ...
                description: 'No back-and-forth emails. Prospects see Emily\'s calendar, pick a time, and book their strategy call—all inside the app.'
              },
              {
                icon: '🎓',
          ...
          <div className="max-w-2xl mx-auto bg-gradient-to-br from-white/80 to-besty-gray-light/80 backdrop-blur-xl rounded-3xl p-8 md:p-10 border-2 border-besty-coral/30">
            ...
            <div className="space-y-3 mb-6">
              {huntCodes.map((item, idx) => {
                ...
                return (
                  <div key={item.code} className="flex items-center gap-3 bg-white/50 rounded-xl p-4">
                    {isFound ? (
                      <>
                      ...
                      <>
                        ...
                        <div className="flex-1">
                          <span className="text-gray-500">Hidden Code #{idx + 1}</span>
                          <span className="text-gray-600 text-xs block">{item.discount} discount</span>
                        </div>
                        <span className="text-gray-600 text-xs">{item.hint}</span>
                      </>
                    )}
                  </div>
                );
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="py-4">
                      ...
                      <p className="text-sm text-gray-600 mt-2">
                        (This special rate never offered again after Halloween)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative bg-gradient-to-br from-besty-coral to-besty-blue text-white px-6 py-3 rounded-full shadow-2xl transform -rotate-12 border-4 border-white">
              <div className="flex items-center gap-2">
                ...
                <div className="text-left">
                  <p className="text-sm font-black leading-tight">Tap Jack!</p>
                  <p className="text-xs font-semibold opacity-90">He's got your back!</p>
                </div>
              </div>
              {/* Sticker shadow effect */}
              <div className="absolute -bottom-1 left-0 right-0 h-1 bg-black/20 blur-sm rounded-full"></div>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer className="bg-white py-12 md:py-16 border-t border-gray-200/30 px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="text-gray-600 text-sm space-y-3">
              ...
              <div className="relative mt-8">
                {interactionScore >= 15 ? (
                  ...
                  <p
                    className="text-[6px] text-gray-800 select-none inline-block opacity-5"
